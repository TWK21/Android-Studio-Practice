...
implements SensorEventListener {
    ...
    private String[] words = new String[]{"Dr.Neat", "Coach Clark", "Ms.Mcleod", "Mrs.Huang", "Mr. Smiley", "Ms. Lau", "Dr. Junge", "Mrs.Gay", "Mr.Freemon", "Coach Zargarian"};
                ...
                while (!this.isInterrupted()) {
                    try {
                        ...
                        TeacherActivity.this.runOnUiThread(new Runnable(){
                             ...
                             */
                            public void run() {
                                if (TeacherActivity.this.time != 0) {
                                    TeacherActivity teacherActivity = TeacherActivity.this;
                                    teacherActivity.time = -1 + teacherActivity.time;
                                } else if (TeacherActivity.this.time == 0) {
                                    TeacherActivity.this.wordTxt.setText((CharSequence)("TIME IS OVER! Score: " + String.valueOf((int)TeacherActivity.this.score)));
                                }
                                TeacherActivity.this.timeTxt.setText((CharSequence)String.valueOf((int)TeacherActivity.this.time));
                            }
                        });
                    }
