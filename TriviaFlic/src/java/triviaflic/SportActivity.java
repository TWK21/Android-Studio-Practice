...
implements SensorEventListener {
    ...
    private String[] words = new String[]{"Pep Squad", "LaCrosse", "Track & Field", "Cross Country", "Softball", "Baseball", "Tennis", "Volley Ball", "Football", "Water Polo"};
                ...
                while (!this.isInterrupted()) {
                    try {
                        ...
                        SportActivity.this.runOnUiThread(new Runnable(){
                             ...
                             */
                            public void run() {
                                if (SportActivity.this.time != 0) {
                                    SportActivity sportActivity = SportActivity.this;
                                    sportActivity.time = -1 + sportActivity.time;
                                } else if (SportActivity.this.time == 0) {
                                    SportActivity.this.wordTxt.setText((CharSequence)("TIME IS OVER! Score: " + String.valueOf((int)SportActivity.this.score)));
                                }
                                SportActivity.this.timeTxt.setText((CharSequence)String.valueOf((int)SportActivity.this.time));
                            }
                        });
                    }
