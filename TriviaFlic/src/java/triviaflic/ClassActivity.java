...
implements SensorEventListener {
    ...
    private String[] words = new String[]{"Computer Science", "History", "English", "PE", "ROTC", "Chemistry", "Drama", "Physiology", "Art", "Ceramics"};
                ...
                while (!this.isInterrupted()) {
                    try {
                        ...
                        ClassActivity.this.runOnUiThread(new Runnable(){
                             ...
                             */
                            public void run() {
                                if (ClassActivity.this.time != 0) {
                                    ClassActivity classActivity = ClassActivity.this;
                                    classActivity.time = -1 + classActivity.time;
                                } else if (ClassActivity.this.time == 0) {
                                    ClassActivity.this.wordTxt.setText((CharSequence)("TIME IS OVER! Score: " + String.valueOf((int)ClassActivity.this.score)));
                                }
                                ClassActivity.this.timeTxt.setText((CharSequence)String.valueOf((int)ClassActivity.this.time));
                            }
                        });
                    }
